...
export const ContractorsView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-amber-50/90 via-orange-50/70 to-slate-50 rounded-2xl p-6 text-slate-900 border border-amber-200/80 shadow-2xs relative overflow-hidden">
        ...
        {/* Micro-KPI Strip */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-amber-200/60">
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs">
                ...
                <div className="flex items-center gap-1.5">
                  <div className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-300 font-bold text-[11px] border border-emerald-200 dark:border-emerald-800/40">
