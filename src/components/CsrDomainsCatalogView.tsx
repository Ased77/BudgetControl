...
export const CsrDomainsCatalogView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-50/90 via-blue-50/70 to-slate-50 rounded-2xl p-6 text-slate-900 border border-indigo-200/80 shadow-2xs relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="bg-white border border-slate-200 rounded-xl px-3.5 py-2 flex items-center gap-3 text-xs shadow-2xs">
              <div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className={`p-1.5 rounded-lg bg-white border border-slate-200 text-slate-600 transition-transform ${isDropdownOpen ? 'rotate-180 text-indigo-600' : ''}`}>
              ...
              {/* Dropdown Menu Popup */}
              {isDropdownOpen && (
                <div className="absolute top-full right-0 left-0 mt-2 bg-white rounded-2xl border border-slate-200 shadow-2xl z-40 p-3 space-y-2 animate-in fade-in zoom-in-95 duration-150 max-h-96 overflow-y-auto">
      ...
      {displayMode === 'DROPDOWN' && activeDomain && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs space-y-4 sticky top-4">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs space-y-4">
              ...
              <div className="space-y-2.5">
                {filteredSubItems.length === 0 ? (
                  <div className="text-center py-10 bg-slate-50/80 rounded-xl border border-dashed border-slate-200">
